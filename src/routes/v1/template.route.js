 ...
 *     description: Only admins can create other templates.
 *     tags: [Templates]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
 ...
 *     description: Logged in templates can fetch only their own template information. Only admins can fetch other templates.
 *     tags: [Templates]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in templates can only update their own information. Only admins can update other templates.
 *     tags: [Templates]
 *     security:
 *       - bearerAuth: []
 *     parameters:
 ...
 *     description: Logged in templates can delete only themselves. Only admins can delete other templates.
 *     tags: [Templates]
 *     security:
 *       - bearerAuth: []
 *     parameters:
